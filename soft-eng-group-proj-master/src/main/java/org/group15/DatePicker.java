...
public class DatePicker extends JPanel {
    ...
    protected URL iconFile = getClass().getResource("datepicker.gif");
    ...
    public void setDate(int day, int month, int year) {
        currentDisplayDate = Calendar.getInstance();
        currentDisplayDate.set(expandYear(year), day, month - 1);
        createPanel();
        validate();
        repaint();
    }
     ...
     */
    protected ImageIcon createImageIcon(URL path, String description) {
